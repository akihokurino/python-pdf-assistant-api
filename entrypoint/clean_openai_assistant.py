...
async def main() -> None:
    ...
    results = await openai_assistant_repository.find_past_openai_assistants(target)
    for result in results:
        ...
        await openai_assistant_repository.delete_assistant_and_update_document(document.id, document)
